...
drop policy if exists "Partners can view own property bookings" on public.bookings;
create policy "Partners can view own property bookings"
...
drop policy if exists "Partners can view own booking history" on public.booking_status_history;
create policy "Partners can view own booking history"
