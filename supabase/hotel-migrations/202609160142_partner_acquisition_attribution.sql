-- Persist only bounded, standard campaign labels with private hotel applications.
-- This does not grant access, approve a property, publish inventory, or enable bookings.
...
comment on function public.validate_partner_onboarding_json(jsonb, boolean, boolean) is
  'Validates bounded self-service registration, optional campaign attribution, and property draft documents.';
