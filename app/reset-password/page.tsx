...
import { recoveryMarkerCookieName, verifyRecoveryMarker } from "@/lib/auth/recovery-marker";
...
export default async function ResetPasswordPage() {
  ...
  const recoveryMarker = cookieStore.get(recoveryMarkerCookieName)?.value;
  const recoveryVerified = user
    ? verifyRecoveryMarker(recoveryMarker, user.id)
    : false;
