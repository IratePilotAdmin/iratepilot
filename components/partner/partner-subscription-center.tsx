...
export function PartnerSubscriptionCenter() {
  ...
  return <div className="mt-8 grid gap-8">
    ...
    <section className="card p-6 text-sm text-slate-600"><strong className="text-slate-900">{partnerEnterprisePlan.name}: {partnerEnterprisePlan.monthlyPriceLabel}/month</strong><p className="mt-2">{partnerEnterprisePlan.audience} Enterprise subscriptions are arranged manually and remain separate from the 13% iRatePilot Group, LLC commission and separate 3% iRate Rewards Program contribution on completed iRatePilot Travel marketplace bookings.</p></section>
