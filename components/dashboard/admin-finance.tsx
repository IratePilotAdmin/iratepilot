...
export function AdminFinance() {
  ...
  return <div className="mt-8 grid gap-8">
    <p className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">Internal accounting only. These figures are created when a booking request is approved; they do not indicate collected funds.</p>
