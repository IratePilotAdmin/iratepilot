...
type Property = { id: string; name: string; type: string; star_rating: number; city: string; country: string; active: boolean; partners?: { business_name?: string } | null };
