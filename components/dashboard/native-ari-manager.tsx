    ...
    <div className="grid gap-6 p-6 xl:grid-cols-2">
      <form className="grid content-start gap-4" onSubmit={(event) => void save(event)}>
        ...
        <div className="grid gap-3">
          <p className="rounded-lg border border-blue-200 bg-blue-50 p-3 text-sm text-blue-900">Each iRatePilot room can map to one PMS room type and rate plan. If you sell another rate plan for the same room type, create a separate iRatePilot room listing for it before mapping. The marketplace currently stores one price per room per night.</p>
