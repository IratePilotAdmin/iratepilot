...
export function PartnerFinance() {
  ...
  return <div className="mt-8 grid gap-8">
    <p className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">Accounting preview only: no traveler payment has been collected. Payouts remain manual until payment processing is activated.</p>
