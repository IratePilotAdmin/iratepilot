...
- [ ] Make a separate provider decision before any provider-contact authorization; packet readiness alone cannot recommend, select, contact, contract, provision, connect, certify, or activate a provider.
