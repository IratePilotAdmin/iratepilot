...
- [ ] Complete and record dedicated authenticated Preview acceptance for the live-activation readiness control center after separate approval.
...
- [ ] Commit, publish, deploy, and complete authenticated Preview acceptance for provider-decision readiness only after separate approval.
