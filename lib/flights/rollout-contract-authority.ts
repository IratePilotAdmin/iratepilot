...
export const flightRolloutContractAuthorityStages: readonly FlightRolloutContractAuthorityStage[] = [
  { id: "route_scope_bound", label: "Route scope bound", owner: "Product + Architecture", detail: "Bind contract review to the selected Duffel-primary and Sabre-secondary planning preference without enabling either route." },
