...
export const DUFFEL_PREVIEW_RUNTIME_BINDING = Object.freeze({
  ...
  executionScopeSha256: sha256("preview:eiqmdldjnedqgbtoozqa:duffel:test:zz:usd:adult:v1"),
  activationEvidenceSha256: sha256("flight-preview-activation:2026-08-25:test-order-rehearsal-v1"),
