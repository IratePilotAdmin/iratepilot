...
export const flightRolloutConsumerLaunchStages: readonly FlightRolloutConsumerLaunchStage[] = [
  ...
  { id: "primary_route_activation_verified", label: "Primary route activation verified", owner: "Architecture + Operations", detail: "Verify the reconciled provider is the sole bounded primary route, the other path remains deferred, and no parallel launch is enabled." },
