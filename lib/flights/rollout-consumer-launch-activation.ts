...
export const flightRolloutConsumerLaunchStages: readonly FlightRolloutConsumerLaunchStage[] = [
  ...
  { id: "primary_route_activation_verified", label: "Primary route activation verified", owner: "Architecture + Operations", detail: "Verify Sabre is the sole bounded primary route and Duffel remains a deferred secondary path with no parallel launch." },
